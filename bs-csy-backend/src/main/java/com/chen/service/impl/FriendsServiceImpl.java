...
public class FriendsServiceImpl extends ServiceImpl<FriendsMapper, Friends>
    ...
    public boolean agreeToApply(User loginUser, Long fromId) {
        ...
        collect.forEach(friend -> {
            ...
            Set<Long> receiveUserIds = com.chen.utils.StringUtils.stringJsonListToLongSet(receiveUser.getFriendIds());
            Set<Long> fromUserUserIds = com.chen.utils.StringUtils.stringJsonListToLongSet(fromUser.getFriendIds());
